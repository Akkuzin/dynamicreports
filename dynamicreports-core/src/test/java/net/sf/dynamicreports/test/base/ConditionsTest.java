...
public class ConditionsTest {
	...
	public void test() {
		...
		conditionTrue("equal", cnd.equal(value, 5.0, 10, 20));
		conditionFalse("equal", cnd.equal(value, 5.0, 20));

		// unequal
		conditionFalse("unequal", cnd.unEqual(value, 5.0, 10, 20));
		conditionTrue("unequal", cnd.unEqual(value, 5.0, 20));
